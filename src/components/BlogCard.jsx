              ...
              <div className="group relative">
                <div className="flex flex-col flex-1">
                  ...
                  <textarea
                    id="message"
                    rows={3}
                    className="block p-2.5 text-sm font-bold text-gray-900  bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-200 dark:focus:ring-blue-500 dark:focus:border-blue-500"
